...
```
node build --copy; site/vendor/bin/phpunit site/tests/unit/Espo/Modules/RunScriptFunction
```
...
```
(cd site && vendor/bin/phpunit tests/integration/Espo/Modules/RunScriptFunction)
```
...
* `site/custom/`
* `site/client/custom/`
* `site/tests/unit/Espo/Modules/RunScriptFunction`
* `site/tests/integration/Espo/Modules/RunScriptFunction`
...
2. Set *bundled* and *jsTranspiled* to true in `src/files/custom/Espo/Modules/RunScriptFunction/Resources/module.json`.
3. Add `src/files/custom/Espo/Modules/RunScriptFunction/Resources/metadata/app/client.json`
    ```json
    {
        "scriptList": [
            "__APPEND__",
            "client/custom/modules/run-script-function/lib/init.js"
        ]
    }
    ```
